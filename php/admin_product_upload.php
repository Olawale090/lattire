        ...
        public function administrator_product_upload(){
                ...
                if (!empty($this->product_category) && !empty($this->product_name) && !empty($this->product_details)
                    ...
                    try {
                            ...
                            $product_upload_query = "INSERT INTO productstable ( product_category,product_name,product_details,
                                                                    product_details,product_price,product_quantity,
                                                                    product_type,product_size,product_material,product_maker,productpicdir)           
                                                    
                                                    WHERE NOT EXISTS (
                                                    SELECT product_name FROM productstable
